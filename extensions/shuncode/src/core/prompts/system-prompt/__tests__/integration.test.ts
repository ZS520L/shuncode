...
const baseContext: SystemPromptContext = {
	...
	focusChainSettings: { enabled: true, remindShuncodeInterval: 6 },
	browserSettings: { viewport: { width: 1280, height: 720 } },
	globalShuncodeRulesFileInstructions: "Follow global rules",
	localShuncodeRulesFileInstructions: "Follow local rules",
...
const contextVariations: Array<{ name: string; override: Partial<SystemPromptContext> }> = [
	...
	{ name: "no-focus-chain", override: { focusChainSettings: { enabled: false, remindShuncodeInterval: 0 } } },
]
...
const modelTestCases = [
	...
	{ family: ModelFamily.DEVSTRAL, modelId: "devstral", providerId: "shuncode" },
	...
	{ family: ModelFamily.NATIVE_NEXT_GEN, modelId: "claude-4-5-sonnet", providerId: "shuncode" },
