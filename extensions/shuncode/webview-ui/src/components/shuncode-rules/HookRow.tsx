...
import { DeleteHookRequest, HooksToggles } from "@shared/proto/shuncode/file"
		...
		<div className="mb-2.5">
			<div className="flex items-center px-2 py-4 rounded bg-text-block-background max-h-4">
				...
				<div className="flex items-center space-x-2 gap-2">
					<div title={isWindows ? t("shuncodeRules.hookTogglingNotSupportedWindows") : undefined}>
						<Switch
							checked={enabled}
							className="mx-1"
							disabled={isWindows}
					...
					<Button
						aria-label={t("shuncodeRules.editHookFile")}
						onClick={handleEditClick}
						size="xs"
						title={t("shuncodeRules.editHookFile")}
						variant="icon">
						<PenIcon />
					</Button>
					<Button
						aria-label={t("shuncodeRules.deleteHookFile")}
						onClick={handleDeleteClick}
						size="xs"
						title={t("shuncodeRules.deleteHookFile")}
						variant="icon">
						<Trash2Icon />
					</Button>
				</div>
