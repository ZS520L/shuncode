...
// 'Add to Shuncode' context menu in editor and code action
// Inserts the selected code into the chat.
export async function addToShuncode(controller: Controller, request: CommandContext, notebookContext?: string): Promise<Empty> {
	...
	Logger.log("addToShuncode", request.selectedText, filePath, request.language)
