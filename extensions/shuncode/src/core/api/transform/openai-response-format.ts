...
/**
 * Converts an array of ShuncodeStorageMessage objects (extension of Anthropic format) to a ResponseInput array to use with OpenAI's Responses API.
 *
 ...
 *
 * @param messages - Array of ShuncodeStorageMessage objects to be converted
 * @returns ResponseInput array containing the transformed messages with proper reasoning pairing
 */
export function convertToOpenAIResponsesInput(messages: ShuncodeStorageMessage[]): ResponseInput {
	const allItems: any[] = []
