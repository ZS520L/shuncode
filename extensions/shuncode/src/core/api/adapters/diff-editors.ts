 ...
 */
export function convertApplyPatchToolCalls(messages: Array<ShuncodeStorageMessage>): Array<ShuncodeStorageMessage> {
 ...
 */
export function convertWriteToFileToolCalls(messages: Array<ShuncodeStorageMessage>): Array<ShuncodeStorageMessage> {
	// Map to track tool_use_id to converted tool info and original input
