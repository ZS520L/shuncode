...
export const BASE_SLASH_COMMANDS: SlashCommand[] = [
	...
	{
		name: "newrule",
		description: "Create a new Shuncode rule based on your conversation",
		section: "default",
		cliCompatible: true,
	},
	{
		name: "reportbug",
		description: "Create a Github issue with ShunCode",
		section: "default",
		cliCompatible: true,
	},
	{
	...
	{
		name: "subagent",
		description: "Invoke a Shuncode CLI subagent for focused research tasks",
		section: "default",
		cliCompatible: true,
	},
]
