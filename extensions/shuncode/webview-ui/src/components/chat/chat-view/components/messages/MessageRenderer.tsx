...
import { findReasoningForApiReq, isEditTool, isFastContextTool, isProcessBlock, isReadFileGroup, isTextMessagePendingToolCall } from "../../utils/messageUtils"
import { EditCard } from "./EditCard"
import { FastContextCard } from "./FastContextCard"
...
interface MessageRendererProps {
	...
	/** Timestamp of the next rendered item in the same turn, used to freeze process timers. */
	nextItemTs?: number
...
export const MessageRenderer: React.FC<MessageRendererProps> = ({
	...
	// Fast Context tool — rendered as standalone card without ChatRow padding
	if (!Array.isArray(messageOrGroup) && isFastContextTool(messageOrGroup)) {
		return <FastContextCard message={messageOrGroup} />
	}
