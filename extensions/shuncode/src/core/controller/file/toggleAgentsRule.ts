import type { ToggleAgentsRuleRequest } from "@shared/proto/shuncode/file"
 ...
 */
export async function toggleAgentsRule(controller: Controller, request: ToggleAgentsRuleRequest): Promise<ShuncodeRulesToggles> {
