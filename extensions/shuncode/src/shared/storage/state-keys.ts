...
import { DEFAULT_SYSTEM_PROMPT_SETTINGS, SystemPromptSettings } from "@shared/SystemPromptSettings"
import { DEFAULT_TOOL_CUSTOMIZATION_SETTINGS, ToolCustomizationSettings } from "@shared/ToolCustomizationSettings"
import { UserInfo } from "@shared/UserInfo"
import { LanguageModelChatSelector } from "vscode"
import { BlobStoreSettings } from "./ShuncodeBlobStorage"
...
// executed automatically to regenerate the proto/shuncode/state.proto file with the
...
const GLOBAL_STATE_FIELDS = {
	...
	remoteRulesToggles: { default: {} as ShuncodeRulesToggles },
	remoteWorkflowToggles: { default: {} as ShuncodeRulesToggles },
	dismissedBanners: { default: [] as Array<{ bannerId: string; dismissedAt: number }> },
	// Path to worktree that should auto-open Shuncode sidebar when launched
...
const USER_SETTINGS_FIELDS = {
	...
	globalShuncodeRulesToggles: { default: {} as ShuncodeRulesToggles },
	globalWorkflowToggles: { default: {} as ShuncodeRulesToggles },
	...
	shuncodeWebToolsEnabled: { default: true as boolean },
	worktreesEnabled: { default: false as boolean },
	// allow-any-unicode-next-line
	preferredLanguage: { default: "中文 (Chinese)" as string },
	alwaysThinkInPreferredLanguage: { default: false as boolean },
	openaiReasoningEffort: { default: "xhigh" as OpenaiReasoningEffort },
	...
	systemPromptSettings: { default: DEFAULT_SYSTEM_PROMPT_SETTINGS as SystemPromptSettings },
	toolCustomizationSettings: { default: DEFAULT_TOOL_CUSTOMIZATION_SETTINGS as ToolCustomizationSettings },

	// Image generation endpoint configuration
	imageGenerationBaseUrl: { default: undefined as string | undefined },
	imageGenerationApiKey: { default: undefined as string | undefined },
	imageGenerationModelId: { default: undefined as string | undefined },
...
const SECRETS_KEYS = [
	"apiKey",
	"shuncodeAccountId", // Shuncode Account ID for Firebase
	"shuncode:shuncodeAccountId",
	"openRouterApiKey",
	"awsAccessKey",
	"awsSecretKey",
	"awsSessionToken",
...
export type LocalState = { [K in (typeof LocalStateKeys)[number]]: ShuncodeRulesToggles }
