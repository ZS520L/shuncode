import { ShuncodeRulesToggles, RuleScope, ToggleWorkflowRequest } from "@shared/proto/shuncode/file"
 ...
 */
export async function toggleWorkflow(controller: Controller, request: ToggleWorkflowRequest): Promise<ShuncodeRulesToggles> {
	...
	return ShuncodeRulesToggles.create({ toggles: toggles })
}
