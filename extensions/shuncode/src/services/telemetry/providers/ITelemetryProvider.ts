...
import type { ShuncodeAccountUserInfo } from "../../auth/AuthService"
...
export interface ITelemetryProvider {
	 ...
	 */
	identifyUser(userInfo: ShuncodeAccountUserInfo, properties?: TelemetryProperties): void
	 ...
	 * @param name Metric name (e.g., "shuncode.tokens.input")
	 ...
	 * Providers that don't support metrics may implement this as a no-op.
	 * @param name Metric name (e.g., "shuncode.api.duration_seconds")
	 ...
	 * Providers that don't support metrics may implement this as a no-op.
	 * @param name Metric name (e.g., "shuncode.workspace.active_roots")
