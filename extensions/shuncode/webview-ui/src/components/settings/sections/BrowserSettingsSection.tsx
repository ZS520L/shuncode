...
export const BrowserSettingsSection: React.FC<BrowserSettingsSectionProps> = ({ renderSectionHeader }) => {
	const { t } = useI18n()
	const { browserSettings, shuncodeWebToolsEnabled } = useExtensionState()
			...
			<Section>
				<div id="browser-settings-section" style={{ marginBottom: 20 }}>
					...
					<div style={{ marginBottom: 10 }}>
						<VSCodeCheckbox
							checked={shuncodeWebToolsEnabled?.user}
							onChange={(e: any) => {
								const checked = e.target.checked === true
								updateSetting("shuncodeWebToolsEnabled", checked)
							}}>
							{t("features.shuncodeWebTools")}
						</VSCodeCheckbox>
						<p
							style={{
								fontSize: "12px",
							...
							{t("features.shuncodeWebToolsDescription")}
						</p>
						<p
							style={{
								fontSize: "12px",
							...
							{t("features.shuncodeWebToolsWarning")}
						</p>
					</div>
