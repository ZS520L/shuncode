...
// Shuncode Provider model schema with per-model settings
export const ShuncodeModelSchema = z.object({
	id: z.string(), // The model ID is required
})

// Shuncode Provider specific settings
export const ShuncodeSettingsSchema = z.object({
	// A list of the allowed models with their settings
	models: z.array(ShuncodeModelSchema).optional(),
})
...
const ProviderSettingsSchema = z.object({
	...
	Shuncode: ShuncodeSettingsSchema.optional(),
...
// Settings for a global shuncode rules or workflow file.
