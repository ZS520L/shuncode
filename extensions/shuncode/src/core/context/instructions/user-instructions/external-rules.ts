...
export async function refreshExternalRulesToggles(
	...
	windsurfLocalToggles: ShuncodeRulesToggles
	cursorLocalToggles: ShuncodeRulesToggles
	agentsLocalToggles: ShuncodeRulesToggles
}> {
 ...
 */
export const getLocalWindsurfRules = async (cwd: string, toggles: ShuncodeRulesToggles) => {
 ...
 */
export const getLocalCursorRules = async (cwd: string, toggles: ShuncodeRulesToggles) => {
 ...
 */
export const getLocalAgentsRules = async (cwd: string, toggles: ShuncodeRulesToggles) => {
