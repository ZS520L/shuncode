...
import type { ToolCustomizationSettings } from "@/shared/ToolCustomizationSettings"
...
export interface PromptVariant {
	...
	// Tool configuration
	readonly tools?: readonly ShuncodeDefaultTool[] // Ordered list of tools to include
	readonly toolOverrides?: Readonly<Partial<Record<ShuncodeDefaultTool, ConfigOverride>>> // Tool customizations
}
...
export interface MutablePromptVariant {
	...
	tools?: ShuncodeDefaultTool[]
	toolOverrides?: Partial<Record<ShuncodeDefaultTool, ConfigOverride>>
}
...
export interface PromptConfig {
	...
	readonly tools?: readonly ShuncodeToolSpec[]
...
export interface SystemPromptContext {
	...
	readonly globalShuncodeRulesFileInstructions?: string
	readonly localShuncodeRulesFileInstructions?: string
	...
	readonly shuncodeIgnoreInstructions?: string
	...
	readonly shuncodeWebToolsEnabled?: boolean
	...
	readonly pinnedMemory?: string
	readonly customSystemPromptTemplate?: string
	readonly toolCustomizationSettings?: ToolCustomizationSettings
...
export type ToolKey = keyof typeof ShuncodeDefaultTool
export type ToolValue = (typeof ShuncodeDefaultTool)[ToolKey]
...
export function isValidShuncodeDefaultTool(tool: string): tool is ShuncodeDefaultTool {
	return Object.values(ShuncodeDefaultTool).includes(tool as ShuncodeDefaultTool)
}
...
export interface VariantBuilder {
	...
	tools(...tools: ShuncodeDefaultTool[]): this
	overrideTool(tool: ShuncodeDefaultTool, override: ConfigOverride): this
