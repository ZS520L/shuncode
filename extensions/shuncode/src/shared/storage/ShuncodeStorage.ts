...
export interface ShuncodeStorageChangeEvent {
	readonly key: string
}

export type StorageEventListener = (event: ShuncodeStorageChangeEvent) => Promise<void>
 ...
 */
export abstract class ShuncodeStorage {
	/**
	 * The name of the storage, used for logging purposes.
	 */
	protected name = "ShuncodeStorage"
	/**
...
/**
 * A simple in-memory implementation of ShuncodeStorage using a Map.
 */
export class InMemoryShuncodeStorage extends ShuncodeStorage {
	/**
