...
export { config as qwenConfig, type QwenVariantConfig } from "./qwen/config"
...
import { config as qwenConfig } from "./qwen/config"
...
export const VARIANT_CONFIGS = {
	...
	/**
	 * Qwen variant - Optimized for Qwen models (3.5, etc.)
	 * Compact instructions with strict editing rules
	 */
	[ModelFamily.QWEN]: qwenConfig,
	/**
