 ...
 * GitOperations Class
 *
 * Handles git-specific operations for Shuncode's Checkpoints system.
 *
...
export class GitOperations {
	...
	public async initShadowGit(gitPath: string, cwd: string, taskId: string): Promise<string> {
		...
		await git.addConfig("user.name", "Shuncode Checkpoint")
		await git.addConfig("user.email", "checkpoint@shuncode-ai.local")
