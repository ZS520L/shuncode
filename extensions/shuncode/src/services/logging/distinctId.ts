 ...
 */
export const _GENERATED_MACHINE_ID_KEY = "shuncode.generatedMachineId"
 ...
 * This is updated to Shuncode User ID when authenticated.
 */
 ...
 * If authenticated, this will be the Shuncode User ID.
