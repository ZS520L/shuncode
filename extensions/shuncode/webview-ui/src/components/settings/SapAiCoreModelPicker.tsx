...
import { SapAiCoreModelDeployment } from "@shared/proto/index.shuncode"
...
const SapAiCoreModelPicker: React.FC<SapAiCoreModelPickerProps> = ({
	...
	const categorizedModels = useMemo(() => {
		...
		// Models that are both deployed AND supported in Shuncode
		...
		// Models that are supported in Shuncode but NOT deployed
