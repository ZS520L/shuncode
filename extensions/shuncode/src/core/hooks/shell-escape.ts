 ...
 *
 * Use cases:
 * - Global hooks directory: ~/Documents/Shuncode/Hooks/
 * - Workspace hooks: /path/to/My Project/.shuncoderules/hooks/
 * - Multi-root workspaces: each root's .shuncoderules/hooks/
 *
 * Examples:
