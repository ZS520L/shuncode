...
import { evaluate_task_variants } from "./evaluate_task"
...
import { read_terminal_variants } from "./read_terminal"
...
import { hashline_edit_variants } from "./hashline_edit"
import { read_files_variants } from "./read_files"
...
export function registerShuncodeToolSets(): void {
	...
	const allToolVariants = [
		...
		...memory_variants,
		...evaluate_task_variants,
		...new_task_variants,
		...plan_mode_respond_variants,
		...read_file_variants,
		...read_terminal_variants,
