...
# 
# Input: { taskId, taskStart: { task: string }, shuncodeVersion, timestamp, ... }
...
# 
# Input: { taskId, taskResume: { task: string }, shuncodeVersion, timestamp, ... }
# Output: { cancel: boolean, contextModification?: string, errorMessage?: string }
# 
# Use cases:
...
# 
# Input: { taskId, taskCancel: { task: string }, shuncodeVersion, timestamp, ... }
# Output: { cancel: boolean, contextModification?: string, errorMessage?: string }
# 
# Use cases:
...
# 
# Input: { taskId, taskComplete: { task: string }, shuncodeVersion, timestamp, ... }
# Output: { cancel: boolean, contextModification?: string, errorMessage?: string }
# 
# Use cases:
...
# 
# Executes when the user submits a prompt to Shuncode.
# 
# Input: { taskId, userPromptSubmit: { prompt: string }, shuncodeVersion, timestamp, ... }
# Output: { cancel: boolean, contextModification?: string, errorMessage?: string }
# 
# Use cases:
