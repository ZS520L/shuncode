...
export class TaskState {
	...
	evaluationTracker: TaskEvaluationTracker = new TaskEvaluationTracker()
	...
	// Failure loop detection: tracks repeated failures on the same tool+target
	// Enables graduated escalation warnings before hitting the hard mistake limit
	lastFailedToolContext: { toolName: string; targetFile?: string; count: number } | null = null
	repeatedFailureLoopCount: number = 0
