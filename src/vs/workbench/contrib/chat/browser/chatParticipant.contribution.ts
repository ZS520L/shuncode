...
// import { KeyCode, KeyMod } from '../../../../base/common/keyCodes.js'; // [SHUNCODE] unused after disabling Copilot Chat view
...
// [SHUNCODE] ChatViewPane import removed — built-in Copilot Chat view disabled
...
// [SHUNCODE] Rebranded Chat container → "ShunCode" — hosts the ShunCode extension webview
Registry.as<IViewContainersRegistry>(ViewExtensions.ViewContainersRegistry).registerViewContainer({
	id: ChatViewContainerId,
	title: { value: 'ShunCode', original: 'ShunCode' }, // [SHUNCODE] Brand name — must NOT be localized
	icon: chatViewIcon,
...
// [SHUNCODE] Disabled built-in Copilot Chat view — ShunCode AI provides its own chat panel in this container
