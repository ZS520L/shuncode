...
export async function refreshWorkflowToggles(
	...
	const globalShuncodeWorkflowsFilePath = await ensureWorkflowsDirectoryExists()
	const updatedGlobalWorkflowToggles = await synchronizeRuleToggles(globalShuncodeWorkflowsFilePath, globalWorkflowToggles)
