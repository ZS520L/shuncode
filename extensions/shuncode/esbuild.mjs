...
if (process.env.SHUNCODE_ENVIRONMENT) {
	buildEnvVars["process.env.SHUNCODE_ENVIRONMENT"] = JSON.stringify(process.env.SHUNCODE_ENVIRONMENT)
}
...
const standaloneConfig = {
	...baseConfig,
	entryPoints: ["src/standalone/shuncode-core.ts"],
	outfile: `${destDir}/shuncode-core.js`,
