 ...
 * @returns A new array of ShuncodeMessage objects with error_retry sequences consolidated.
 *
 * @example
 ...
 */
export function combineErrorRetryMessages(messages: ShuncodeMessage[]): ShuncodeMessage[] {
