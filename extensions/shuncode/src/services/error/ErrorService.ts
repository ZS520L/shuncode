...
import { ShuncodeError } from "./ShuncodeError"
import { ErrorProviderFactory } from "./ErrorProviderFactory"
import { IErrorProvider } from "./providers/IErrorProvider"

/**
 * ErrorService handles error logging and tracking for the Shuncode extension
...
export class ErrorService {
	...
	public logException(error: Error | ShuncodeError, properties?: Record<string, unknown>): void {
	...
	public toShuncodeError(rawError: unknown, modelId?: string, providerId?: string): ShuncodeError {
		const transformed = ShuncodeError.transform(rawError, modelId, providerId)
