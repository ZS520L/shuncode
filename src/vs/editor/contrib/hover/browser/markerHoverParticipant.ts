...
// --- SHUNCODE_FORK_BEGIN: removed unused ThemeIcon/Codicon imports (Copilot Fix button removed) ---
// --- SHUNCODE_FORK_END ---
	...
	private _renderMarkerStatusbar(context: IEditorHoverRenderContext, markerHover: MarkerHover): IDisposable {
		...
		if (!this._editor.getOption(EditorOption.readOnly)) {
			...
			codeActionsPromise.then(actions => {
				...
				// --- SHUNCODE_FORK_BEGIN: remove Copilot "Fix" button from error hover ---
				// Shuncode uses Quick Fix menu (Ctrl+.) with "Fix with Shuncode" instead.
				// --- SHUNCODE_FORK_END ---
