import type { OpenRouterModelInfo } from "@shared/proto/shuncode/models"
import type { OnboardingModel, OnboardingModelGroup } from "@shared/proto/shuncode/state"
...
export function getShuncodeUIOnboardingGroups(groupedModels: OnboardingModelGroup): OnboardingModelsByGroup {
