...
export class PostHogTelemetryProvider implements ITelemetryProvider {
	...
	public identifyUser(userInfo: ShuncodeAccountUserInfo, properties: TelemetryProperties = {}): void {
	...
	public recordCounter(
		...
		if (name === "shuncode.tokens.input.total" || name === "shuncode.tokens.output.total") {
	...
	public recordGauge(
		...
		if (name === "shuncode.workspace.active_roots") {
