...
/**
 * Combines API request start and finish messages in an array of ShuncodeMessages.
 *
 ...
 * @returns A new array of ShuncodeMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: ShuncodeMessage[]): ShuncodeMessage[] {
	const combinedApiRequests: ShuncodeMessage[] = []
