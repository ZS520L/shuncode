import { clearOnboardingModelsCache, getShuncodeOnboardingModels } from "@/core/controller/models/getShuncodeOnboardingModels"
import type { OnboardingModel } from "@/shared/proto/shuncode/state"
...
export class FeatureFlagsService {
	...
	public async poll(userId: string | null): Promise<void> {
		...
		getShuncodeOnboardingModels() // Refresh onboarding models cache if relevant flag changed
	}
