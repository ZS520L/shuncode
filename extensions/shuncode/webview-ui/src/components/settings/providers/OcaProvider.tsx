...
import type { OcaAuthState, OcaUserInfo } from "@shared/proto/index.shuncode"
import { EmptyRequest, StringRequest } from "@shared/proto/index.shuncode"
			...
			{!ready ? (
				...
				<div>
					...
					<p className="text-xs mt-0 text-(--vscode-descriptionForeground)">
						...
						<VSCodeLink
							href="https://confluence.oraclecorp.com/confluence/display/AICODE/Oracle+Code+Assist+via+Shuncode"
