...
import type { ShuncodeToolResponseContent } from "@shared/messages"
...
export interface CommandExecutorCallbacks {
	...
	/**
	 * Update a shuncode message by index
	 * Supports updating commandCompleted status and/or text content
	 */
	updateShuncodeMessage: (index: number, updates: { commandCompleted?: boolean; text?: string }) => Promise<void>
	/** Get shuncode messages array */
	getShuncodeMessages: () => Array<{ ask?: string; say?: string; text?: string }>
...
export interface OrchestrationResult {
	...
	result: ShuncodeToolResponseContent
