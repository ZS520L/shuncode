 ...
 *
 * The generated proto content is written to proto/shuncode/state.proto,
...
const STATE_PROTO_PATH = "proto/shuncode/state.proto"
...
function parseSecretsKeys(sourceFile) {
	...
	for (const element of initializer.getElements()) {
		...
		// Skip prefixed keys like "shuncode:shuncodeAccountId"
		if (!key.includes(":")) {
			keys.push(key)
		}
	}
