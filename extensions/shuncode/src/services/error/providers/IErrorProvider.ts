...
import type { ShuncodeError } from "../ShuncodeError"
...
export interface IErrorProvider {
	 ...
	 * @param error The error to log (Error or ShuncodeError)
	 * @param properties Optional additional properties to attach
	 */
	logException(error: Error | ShuncodeError, properties?: Record<string, unknown>): void
