...
export interface IGitHubReleasesUpdateConfiguration {
	readonly owner: string;
	readonly repo: string;
	readonly apiUrl?: string;
	readonly includePrereleases?: boolean;
	readonly assetNamePatterns?: IStringDictionary<readonly string[]>;
}
...
export interface IProductConfiguration {
	...
	readonly githubUpdate?: IGitHubReleasesUpdateConfiguration;
