...
export function UnsavedChangesDialog({
	...
	const { t } = useI18n()
	const resolvedTitle = title ?? t("dialog.unsavedChanges")
	const resolvedDescription = description ?? t("dialog.unsavedChangesDescription")
	const resolvedConfirmText = confirmText ?? t("dialog.discardChanges")
	const resolvedSaveText = saveText ?? t("dialog.saveAndContinue")
