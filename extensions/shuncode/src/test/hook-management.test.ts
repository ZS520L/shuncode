...
import { CreateHookRequest, DeleteHookRequest, ToggleHookRequest } from "../shared/proto/shuncode/file"
...
describe("Hook Management", () => {
	...
	beforeEach(async () => {
		...
		globalHooksDir = path.join(tempDir, "global", "Documents", "Shuncode", "Hooks")
		workspaceHooksDir = path.join(tempDir, "workspace", ".shuncoderules", "hooks")
	...
	describe("Edge Cases", () => {
		it("should handle missing .shuncoderules directory gracefully", async function () {
			this.timeout(5000)
