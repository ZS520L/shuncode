 ...
 * - JetBrains (using StandaloneTerminalManager via shuncode-core)
 *
 * @example
 * ```typescript
...
// Export interactive responder
export { TerminalInteractiveResponder } from "./TerminalInteractiveResponder"
export type { InteractiveResponderConfig, PromptDetectionResult } from "./TerminalInteractiveResponder"
