...
import type { OnboardingModel, OnboardingModelGroup, OpenRouterModelInfo } from "@shared/proto/index.shuncode"
...
const OnboardingView = ({ onboardingModels }: { onboardingModels: OnboardingModelGroup }) => {
	...
	const models = useMemo(() => getShuncodeUIOnboardingGroups(onboardingModels), [onboardingModels])
	...
	return (
		<div className="fixed inset-0 p-0 flex flex-col w-full">
			<div className="h-full px-5 xs:mx-10 overflow-auto flex flex-col gap-4 items-center justify-center">
				<ShuncodeLogoWhite className="size-16 flex-shrink-0" />
