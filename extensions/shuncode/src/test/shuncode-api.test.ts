...
import type { ShuncodeAPI } from "../exports/shuncode"
import { setVscodeHostProviderMock } from "./host-provider-test-utils"

describe("ShuncodeAPI Core Functionality", () => {
	let api: ShuncodeAPI
	...
	beforeEach(async () => {
		...
		// Create a mock controller that matches what the real createShuncodeAPI expects
		...
		// Create API instance
		api = createShuncodeAPI(mockController)
	})
