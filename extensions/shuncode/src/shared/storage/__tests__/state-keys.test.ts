...
describe("State Keys Type Safety", () => {
	...
	describe("Type Exports", () => {
		...
		it("should export usable key types", () => {
			...
			const localKey: LocalStateKey = "localShuncodeRulesToggles"
		...
		it("should have LocalState keys map to ShuncodeRulesToggles", () => {
			const localState: Partial<LocalState> = {
				localShuncodeRulesToggles: {},
				localCursorRulesToggles: { "some-rule": true },
			}
			expect(localState.localShuncodeRulesToggles).to.deep.equal({})
		})
	})
	...
	describe("Edge Cases", () => {
		...
		it("should handle keys with special characters", () => {
			// The shuncode:shuncodeAccountId key has a colon
			expect(SecretKeys).to.include("shuncode:shuncodeAccountId")
			expect(isSecretKey("shuncode:shuncodeAccountId")).to.be.true
		})
