			...
			const messages: Anthropic.Messages.MessageParam[] = [
				...
				{ role: "assistant", content: "Response" },
				{
					...
					content: [
						...
						{
							type: "text",
							text: "New message to respond to:\n<user_message>\n'test.txt' (see above for file content) tell me whats in this file\n</user_message>\n\n<file_content path=\"test.txt\">\ntest 2\n\n</file_content>",
						},
					],
				},
			]
					...
					content: [
						{
							...
							content: [
								{
									type: "text",
									text: "[plan_mode_respond] Result:\n<user_message>\n'test2.txt' (see above for file content)\n</user_message>\n\n<file_content path=\"/Users/toshi/Desktop/shuncode_testing_repo/test2.txt\">\ntest\n\n</file_content>",
								},
							],
						},
					],
					...
					content: [
						{
							...
							content: [
								{
									type: "text",
									text: "[write_to_file for '/Users/toshi/Desktop/shuncode_testing_repo/test2.txt'] Result:\nThe content was successfully saved.\n\n<final_file_content path=\"/Users/toshi/Desktop/shuncode_testing_repo/test2.txt\">\ntest\n\n</final_file_content>",
								},
							],
						},
					...
					content: [
						{
							...
							content: [
								{
									type: "text",
									text: "[replace_in_file for '/Users/toshi/Desktop/shuncode_testing_repo/test2.txt'] Result:\nThe content was successfully saved.\n\n<final_file_content path=\"/Users/toshi/Desktop/shuncode_testing_repo/test2.txt\">\ntest2\n\n</final_file_content>",
								},
							],
						},
						{ type: "text", text: "<environment_details>\n# Current Mode\nACT MODE\n</environment_details>" },
