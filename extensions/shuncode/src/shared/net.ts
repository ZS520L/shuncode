 ...
 * ## Proxy Support
 *
 * Shuncode uses platform-specific fetch implementations to handle proxy
 * configuration:
 ...
 * 3. View logs: Check ~/.shuncode/shuncode-core-service.log for network-related
 *    failures.
