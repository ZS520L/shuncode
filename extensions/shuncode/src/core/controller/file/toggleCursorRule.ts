import type { ToggleCursorRuleRequest } from "@shared/proto/shuncode/file"
import { ShuncodeRulesToggles } from "@shared/proto/shuncode/file"
 ...
 */
export async function toggleCursorRule(controller: Controller, request: ToggleCursorRuleRequest): Promise<ShuncodeRulesToggles> {
	...
	return ShuncodeRulesToggles.create({
