...
const id = ShuncodeDefaultTool.SEARCH
...
const generic: ShuncodeToolSpec = {
	...
	name: "search_files",
	description:
		"Request to perform a regex search across files in a specified directory, providing context-rich results. Use this for exact patterns, identifiers, and literals; for semantic questions about where logic is implemented, prefer fast_context first and use this as a fallback.",
	parameters: [
		{
			name: "path",
			required: true,
