...
/**
 * Combines sequences of command and command_output messages in an array of ShuncodeMessages.
 *
 * This function processes an array of ShuncodeMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of ShuncodeMessage objects to process.
 * @returns A new array of ShuncodeMessage objects with command sequences combined.
 *
 * @example
 * const messages: ShuncodeMessage[] = [
 ...
 */
export function combineCommandSequences(messages: ShuncodeMessage[]): ShuncodeMessage[] {
	const combinedCommands: ShuncodeMessage[] = []
