...
const en: Record<string, string> = {
	...
	"dictation.installWithShunCode": "Install with ShunCode",
	"dictation.copyCommand": "Copy Command",
	"dictation.dismiss": "Dismiss",
	"dictation.signIn": "Sign in to ShunCode",
...
const ru: Record<string, string> = {
	...
	// allow-any-unicode-next-line
	"dictation.installWithShunCode": "Установить через ShunCode",
	// allow-any-unicode-next-line
	"dictation.copyCommand": "Скопировать команду",
	// allow-any-unicode-next-line
	"dictation.dismiss": "Закрыть",
	// allow-any-unicode-next-line
	"dictation.signIn": "Войти в ShunCode",
