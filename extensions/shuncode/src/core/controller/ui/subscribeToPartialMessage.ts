...
import { ShuncodeMessage } from "@shared/proto/shuncode/ui"
import { Logger } from "@/shared/services/Logger"
import { getRequestRegistry, StreamingResponseHandler } from "../grpc-handler"
import { Controller } from "../index"

// Keep track of active partial message subscriptions
const activePartialMessageSubscriptions = new Set<StreamingResponseHandler<ShuncodeMessage>>()
...
export async function subscribeToPartialMessage(
	...
	responseStream: StreamingResponseHandler<ShuncodeMessage>,
	requestId?: string,
): Promise<void> {
 ...
 * @param partialMessage The ShuncodeMessage to send
 */
export async function sendPartialMessageEvent(partialMessage: ShuncodeMessage): Promise<void> {
