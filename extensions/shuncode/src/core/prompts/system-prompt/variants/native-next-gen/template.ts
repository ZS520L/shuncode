...
export const SYSTEM_INFO = (context: SystemPromptContext) => {
...
Working Directory: ${context.cwd || "unknown"}${gitSection}`
}
...
- The current working directory is \`{{CWD}}\` - this is the directory where all the tools will be executed from.${context.enableParallelToolCalling
			? `
