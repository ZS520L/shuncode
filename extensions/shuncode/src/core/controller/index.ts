...
export class Controller {
	...
	*/
	...
	// [SHUNCODE-PERF] Cache voice readiness to avoid 3× fs.existsSync on every state push.
	...
	// [SHUNCODE-PERF] Initialize WhisperLocalService once, not on every state push
	...
	async getStateToPostToWebview(): Promise<ExtensionState> {
		...
		// [SHUNCODE] TEMPORARILY DISABLED — legacy Cline checkpoint error message
		...
		// [SHUNCODE-PERF] Voice readiness — cached, no fs.existsSync on every call
