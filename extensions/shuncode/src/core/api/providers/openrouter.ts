		...
		if (!this.client) {
			...
			try {
				this.client = new OpenAI({
					...
					defaultHeaders: {
						"HTTP-Referer": "https://shuncode-ai.local", // Optional, for including your app on openrouter.ai rankings.
						"X-Title": "Shuncode", // Optional. Shows in rankings on openrouter.ai.
					},
